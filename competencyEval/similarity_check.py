...
def para_similarity(para_1, para_2):
    """
        Calculate the semantic similarity between two paragraps..
    """
    sentences_1 = nltk.sent_tokenize(para_1)
    sentences_2 = nltk.sent_tokenize(para_2)
    max_sims = []
    for sents_1 in sentences_1:
        max_sim = 0
        max_sent = ''
        for sents_2 in sentences_2:
            sim_true = similarity(sents_1, sents_2, True)
            if sim_true > max_sim:
                max_sim = sim_true
                max_sent = sents_2
...
#     best_pair = get_best_synset_pair(word_pair[0], word_pair[1])
#     print("%s\t%s\t%.2f\t%.2f" % (word_pair[0], word_pair[1], word_pair[2],best_pair[0].wup_similarity(best_pair[1])))
#
#
# sentence_pairs = [
#     ["i came to know that isuru is a good guy.", "isuru is a very good guy", 1],
#     ["Isuru is very nice.", "Is Isuru very nice?", 0.977],
...
#     print(sent_pair[0], sent_pair[1], sent_pair[2],similarity(sent_pair[0], sent_pair[1], False),similarity(sent_pair[0], sent_pair[1], True))
para_1 = "java is a fully object oriented programming language. The main component of the language is object. the best thing about this is the java run time environment"
para_2 = "java is a language. java is object oriented."
